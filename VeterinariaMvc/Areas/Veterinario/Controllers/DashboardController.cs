...
namespace VeterinariaMvc.Areas.Veterinario.Controllers
{
    ...
    public class DashboardController : Controller
    {
		...
		public DashboardController(IConsultaVeterinarioService consultaVeterinarioService, IVeterinarioService veterinarioService, IPlantillaService plantillaService)
        {
